...
time LD_LIBRARY_PATH=$DEBUG_LIB_PATH:$OLD_LD_PATH java $JAVA_OPTS -agentlib:j9objrecord -jar tiny-rules-sample.jar

echo call with agent, debug
time LD_LIBRARY_PATH=$RELEASE_LIB_PATH:$OLD_LD_PATH java $JAVA_OPTS -agentlib:j9objrecord -jar tiny-rules-sample.jar
